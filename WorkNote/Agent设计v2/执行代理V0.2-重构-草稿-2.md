...
rectangle "worker" as worker <<$supbService>><<behavior>> #Application
...
obj_collector -down- worker
worker -down-* obj_driver

obj_heartbeat -right-* worker
obj_heartbeat -down-* rpc_client
obj_manager -down-* rpc_client
worker -down-* rpc_client
