...
kubectl -n test-helm-social-network port-forward --address=0.0.0.0 svc/nginx-thrift 10999:8080
./wrk -D exp -t 1 -c 1 -d 20 -L -s ./scripts/social-network/compose-post.lua http://localhost:10999/wrk2-api/post/compose -R 1
